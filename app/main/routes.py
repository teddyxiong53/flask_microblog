...
from flask import flash, redirect, url_for, request, g, jsonify, current_app
...
def explore():
    ...
    return render_template('index.html', title='浏览', posts=posts.items, next_url=next_url, prev_url=prev_url)
